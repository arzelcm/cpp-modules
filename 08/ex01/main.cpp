...
void	extraTest()
{
	...
	span4.addNumber(array, array + 5);
	span5.addNumber(array2, array2 + 10);
	Span	span6(span5);
	...
	span7.addNumber(array2, array2 + 2);
	span7.listNumbers();

	try
	{
		span7.addNumber(array + 2, array + 6);
		span7.listNumbers();
	}
	catch (std::exception &e)
	{
